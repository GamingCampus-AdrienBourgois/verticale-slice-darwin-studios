...
public:
	MainMenuScene() : Scene("MainMenuScene")
	{
		...
		GameObject* credit_game_button = CreateSpriteButton_forMainMenu(ButtonType, "main_menu_credits_button", Maths::Vector2f((window_size.x / 10) * 2, (window_size.y - window_size.y * 3 / 6)), Maths::Vector2f(window_size.x / 15 * 3, (((window_size.x / 15) * 3) * 168 / 448)), /*[this] {CreditsMenu(); }*/ [] {}, nullptr, "texture_button_Credits", Maths::Vector2f(448, 168), Maths::Vector2f(0, 24));
