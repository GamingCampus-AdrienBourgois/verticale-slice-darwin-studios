...
public:
	MainMenuScene() : Scene("MainMenuScene")
	{
		...
		GameObject* play_game_button = CreateSpriteButtonWithText(ButtonType, "main_menu_play_button", Maths::Vector2f((window_size.x / 2) - (window_size.x / 15), (window_size.y - window_size.y * 5 / 6)), Maths::Vector2f(window_size.x / 15 * 2, window_size.y / 10), [this] {LaunchCapacityMenu(); }, nullptr, "texture_button", Maths::Vector2f(448, 98), Maths::Vector2f(24,0), "Jouer", sf::Color::Black, 40);
