...
DeathScene::DeathScene() : Scene("DeathScene") {
	...
	GameObject* checkpointtButton = CreateSpriteButtonWithText(ButtonType, "Checkpoint_button", Maths::Vector2f(((window_size.x / 2) - (button_size_x / 2)), window_size.y * 5 / 6), Maths::Vector2f(button_size_x, button_size_y), [this] { LaunchFunction::resumeGame(); }, nullptr, "texture_button", Maths::Vector2f(448, 168), Maths::Vector2f(0, 24), "Retour au dernier checkpoint", sf::Color::Black, 30);
	...
	GameObject* quitButton = CreateSpriteButtonWithText(ButtonType, "quit_button", Maths::Vector2f(((window_size.x / 2) - (button_size_x / 2)), window_size.y * 3 / 6), Maths::Vector2f(button_size_x, button_size_y), [this] { LaunchFunction::LaunchScene<MainMenuScene>(); }, nullptr, "texture_button", Maths::Vector2f(448, 168), Maths::Vector2f(0, 24), "Retour au menu", sf::Color::Black, 30);

	textPause->GetComponent<TextRenderer>()->SetString("Vous etes mort");
}